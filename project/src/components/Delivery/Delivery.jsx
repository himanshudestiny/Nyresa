  ...
  return (
    <div>
      ...
      <SimpleGrid columns={[1, 2, 2, 2, 2, 2]} spacing={0} mt={["50"]} mb="10">
            ...
            >
              <SimpleGrid columns={1} spacing={0}>
                ...
                <Box height="50px">
                  ...
                  >
                    <Stack direction="row">
                      <Radio value="Ms." colorScheme="blackAlpha">
                        Ms.*
                      </Radio>
                      <Radio value="Mrs." colorScheme="blackAlpha">
                        Mrs.*
                      </Radio>
                      <Radio value="Mr." colorScheme="blackAlpha">
                        Mr.*
                      </Radio>
                    </Stack>
                  </RadioGroup>
                ...
                <Box height="50px" align="left">
                  <form action="">
                    <SimpleGrid columns={1} spacing={3}>
                      ...
                      <button></button>
                      <Box height="10px" align="left"></Box>
                      <Box height="50px" align="left">
                        BILLING ADDRESS
                      </Box>
                      <Box height="50px" align="left">
                        If your billing address differs from your shipping
                        address, please click "add billing address".
                      </Box>
                      <Box height="10px" align="left"></Box>
                      <Box height="50px" align="left">
                      ...
                      <Box height="50px" align="left"></Box>
                      <Box height="50px" align="left">
                        <Button colorScheme="gray" size="md">
        ...
        <Box
          height="1100px"
          borderLeft={["0px", "0px", "1px", "1px", "1px", "1px"]}
        ...
        >
          <SimpleGrid
            ...
            spacing={1}
            align="left"
            w={["118%", "95%", "75%", "80%", "70%", "70%"]}
            ml={[3, 5, 70, 70, 70, 70]}
          >
            <Box height="50px">SHIPPING METHOD</Box>
            <Box
              height="auto"
              border="1px"
              borderColor="grey"
            ...
            <Box mt="-8">2-4 business days delivery time</Box>
            <Box
              height="10"
              borderBottom="1px"
              ...
              mt="-10"
            ></Box>
            <Box mt="5">PACKAGING OPTIONS</Box>
            <SimpleGrid
              columns={[1, 1, 1, 2, 2, 2]}
              spacing={10}
              mt="5"
            ...
            >
              <Box
                height={["200", "180", "140", "140", "140", "140"]}
              ...
              >
                <RadioGroup
                  ...
                  value={mPack}
                  onChange={setMPack}
                  onClick={() => setMPack(value)}
                >
                  <Stack direction="row">
                    <Radio value="Mytheresa Packaging" colorScheme="blackAlpha">
                      Mytheresa packaging
                    </Radio>
                  </Stack>
                </RadioGroup>
              ...
              <Box
                height={["200", "180", "160", "140", "140", "140"]}
                w={["100%", "100%", "100%", "100%", "100%", "100%"]}
              >
                <RadioGroup
                  fontWeight="bold"
                  value={ePack}
                  onChange={setEPack}
                  onClick={() => setEPack(value)}
                >
                  <Stack direction="row">
                    <Radio value="Eco packaging" colorScheme="blackAlpha">
                      Eco packaging
                    </Radio>
                  </Stack>
                </RadioGroup>
