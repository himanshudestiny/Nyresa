...
const Payment = () => {
  ...
  return (
    <div>
      ...
      >
        <Box
          height={["95px", "95px", "70px", "70px", "70px", "70px"]}
          borderBottom="1px"
          align="left"
          borderColor="grey"
          w={["110%", "95%", "100%", "100%", "100%", "100%"]}
        >
          ...
          >
            <Box height="auto">
              <SimpleGrid columns={1} spacing={1} align="left">
                ...
                <Box mt="-3" ml="6" height="40px" color="grey">
                  Immediate Shipping
                </Box>
              </SimpleGrid>
            </Box>
              ...
              <SimpleGrid columns={1} spacing={1} mt={[-10, -10, 0, 0, 0, 0]}>
                <Box height="40px">
                  ...
                  >
                    ...
                    <GridItem w="100%" h="10">
                      <Image h="8" src={visa}></Image>
                    </GridItem>
                    <GridItem w="100%" h="10">
                      <Image h="8" src={masterCard}></Image>
                    </GridItem>
                    <GridItem w="100%" h="10">
                      <Image h="8" src={dinersClub}></Image>
                    </GridItem>
                    <GridItem w="100%" h="10">
                      <Image h="8" w="12" src={jcb}></Image>
                    </GridItem>
                    <GridItem w="100%" h="10">
                      <Image h="8" src={unionPay}></Image>
                    </GridItem>
                  </Grid>
                </Box>
        ...
        <Box
          h={[100, 70, 70, 70, 70, 70]}
          mt={[20, 20, 10, 10, 10, 10]}
          w="100%"
          align="left"
          opacity="90%"
          borderBottom="1px"
        ...
        >
          {" "}
          <Box w={["120%", "100%", "70%", "70%", "36%", "36%"]}>
            {" "}
            Please note: By clicking this button, all data listed on this page
            will be erased for security reasons.
          </Box>{" "}
        </Box>
        <Box h="16">
          {" "}
