          ...
          <Box width="100%" height="auto">
            {product.map((el) => (
              ...
              >
                <ListChild
                  ...
                  image={el.images[el.images.length - 1]}
                  quant={el.quantity}
                  getData={getData}
            ...
            {product.length === 0 && (
              <Box borderTop="1px solid grey" m="auto" lineHeight={8}>
                ...
                <Text color="grey">
                  Check out our new arrivals and start adding to your wishlist
                  now!
                </Text>
                <Button mt={4}>
                  {" "}
                  <Link to="/menproduct">SHOP NEW ARRIVALS</Link>
                </Button>
              </Box>
            )}
            <Box
