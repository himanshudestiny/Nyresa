...
const Product = ({ title, desc, price, quantity, subTotal, size, image }) => {
  return (
    <div>
      <SimpleGrid
        columns={[1, 1, 1, 2, 2, 2]}
        ...
        borderTop="1px"
        borderColor="grey"
        w={["95%", "95%", "95%", "100%", "100%", "100%"]}
      >
        <Box
          height={["260px", "260px", "260px", "180px", "180px", "180px"]}
          borderTop="1px"
        ...
        <Box height="auto" align="right" borderTop="1px" borderColor="gray.300">
          <Box h="120%" w="50%" mt="-8">
            <Grid templateColumns="repeat(3, 1fr)" gap={6}>
              <GridItem w="100%" h="10" align="center" fontWeight="bolder">
                Price
              </GridItem>
              <GridItem w="100%" h="10" align="center" fontWeight="bolder">
                Quantity
            ...
            <Grid templateColumns="repeat(3, 1fr)" gap={6}>
              <GridItem w="100%" h="10" align="center" opacity="80%">
                ${price}
              </GridItem>
