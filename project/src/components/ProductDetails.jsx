...
const ProductDetails = () => {
  ...
  return (
    <Box marginTop={"40px"}>
      <Center>
        <Box
          className="Product_details_Mega_container"
        ...
        >
          ...
          <div className="Product_details_Mega_container_second_child">
            <Text margin={"20px"} fontSize={"20px"} fontWeight={"bold"}>
              {element.title}
            </Text>
            ...
            <Flex>
              ...
              <Text marginLeft={"20px"} textDecorationLine={"line-through"}>
              ...
              {flag ? (
                <PopoverContent padding={"20px"}>
                  ...
                  <Button
                    ...
                    color={"white"}
                    bgColor={"black"}
                    onClick={() => handleShopingBag(element, element.id)}
                  >
                    VIEW SHOPPING BAG
                  </Button>
                  <Button marginTop={"10px"} onClick={() => setFlag(false)}>
                    BACK TO SHOP
                  </Button>
                </PopoverContent>
              ) : (
              ...
              {flag ? (
                <PopoverContent padding={"20px"}>
                  ...
                  <Button
                    ...
                    color={"white"}
                    bgColor={"black"}
                    onClick={() => handleWishlistBag(element)}
                  >
                    VIEW WISHLIST{" "}
                    <svg
                      style={{ marginLeft: "5px" }}
